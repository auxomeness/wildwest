...
#define ACTION_PHASE_ULTIMATE_MS 20000
#define REVEAL_REPOSITION_MS 15000
#define RESOLVE_PHASE_MS 2000
#define RESOLVE_BULLET_STEP_MS 120
#define ULT_BARRAGE_BULLETS 3
...
typedef struct {
    ...
    int bullet2_col;
    int bullet2_active;
    int p1_ult_bullet_row[ULT_BARRAGE_BULLETS];
    int p1_ult_bullet_col[ULT_BARRAGE_BULLETS];
    int p1_ult_bullet_active[ULT_BARRAGE_BULLETS];
    int p2_ult_bullet_row[ULT_BARRAGE_BULLETS];
    int p2_ult_bullet_col[ULT_BARRAGE_BULLETS];
    int p2_ult_bullet_active[ULT_BARRAGE_BULLETS];
